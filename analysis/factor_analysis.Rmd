...
The results here suggest metric invariance. We still do not achieve scalar invariance. This can be addressed in the model by allowing a random slope on each of the morality variables. 
