...
random slopes from Model 3 of Table 1. Each panel is ordered from
...
Values are based on random intercepts and slopes from Model 3 of Table
1. Best fitting OLS line is shown for both panels.}
\label{fig4}
\end{adjustwidth}
\end{figure}
